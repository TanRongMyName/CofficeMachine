...
import com.coffice.shengtao.cofficemachine.data.model.timePicker.CardBean;
import com.coffice.shengtao.cofficemachine.data.model.timePicker.ProvinceBean;
...
public class PickerViewActivity extends BaseActivity {
    ...
    Button btnCustomOptions;
    @BindView(R.id.btn_no_linkage)
    Button btnNoLinkage;
    @BindView(R.id.btn_GotoJsonData)
    Button btnGotoJsonData;
...
//        pvOptions.setSelectOptions(1,1);
    ...
    @OnClick({R.id.btn_lunar, R.id.btn_Time, R.id.btn_Options, R.id.btn_CustomTime, R.id.btn_CustomOptions, R.id.btn_no_linkage, R.id.btn_GotoJsonData, R.id.btn_fragment})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.btn_lunar:
                pvCustomLunar.show();
                break;
            case R.id.btn_Time: //弹出时间选择器，传递参数过去，回调的时候则可以绑定此view
                if(pvTime!=null){
                    pvTime.show();
                }
                break;
            case R.id.btn_Options: //弹出条件选择器
                ...
                break;
            case R.id.btn_CustomTime: //弹出自定义条件选择器
                if(pvCustomTime!=null){
                    pvCustomTime.show();
                }
                break;
            case R.id.btn_CustomOptions: //弹出自定义时间选择器
            ...
            case R.id.btn_GotoJsonData: //跳转到 省市区解析示例页面
                ...
                break;
            case R.id.btn_fragment: //跳转到 fragment
