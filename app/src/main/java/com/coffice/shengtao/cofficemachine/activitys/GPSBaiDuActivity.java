...
public class GPSBaiDuActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gpsbai_du);
        tv=findViewById(R.id.addressinfo);
        startLocate();
    }
    ...
    private void showScanCodeTip() {
        ...
        dialog.show(getSupportFragmentManager(), GPSBaiDuActivity.class.getSimpleName());
    }
