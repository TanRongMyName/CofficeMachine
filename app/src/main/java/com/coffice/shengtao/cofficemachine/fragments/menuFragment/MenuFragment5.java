 ...
 */
public class MenuFragment5 extends BaseFragment {
    ...
    private void initDemoSettings(View view) {
        ...
        final AHBottomnavigationActivity demoActivity = (AHBottomnavigationActivity) getActivity();
    ...
    private void initDemoList(View view) {
        ...
        for (int i = 0; i < 50; i++) {
         ...
         RecycleDataBaseAdapter adapter = new RecycleDataBaseAdapter(getContext(),itemsData,android.R.layout.simple_list_item_1) {
             @Override
